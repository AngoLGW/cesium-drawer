...
import { GLOBE_PLOT_LAYER, STRAIGHT_ARROW_3 } from "../config/constant";
import * as Cesium from "cesium";
import { v4 as uuidv4 } from "uuid";
import ee from "../../../utils/eventEmitter";

class PlotStraightArrow3Drawer {
  constructor(viewer, options, data) {
     ...
     * 材质
     */
    this.material = new Cesium.PolylineArrowMaterialProperty(
...
export default PlotStraightArrow3Drawer;
